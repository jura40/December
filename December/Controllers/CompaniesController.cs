...
namespace December.Controllers
{
    public class CompaniesController : Controller
    {
        ...
        public CompaniesController(EmployeContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("CompanyId,CompanyName,CompanyTypes")] Company company)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("CompanyId,CompanyName,CompanyTypes")] Company company)
        {
